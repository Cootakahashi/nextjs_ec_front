...
export default function Ranking({ Rankingsections, onSelectComponent }) {
  ...
  return (
    <div className="your-class md:py-28 pt-10 relative">
      {" "}
      {/* relative追加 */}
      <header className="w-full text-slate-200 flex justify-content md:text-xs md:text-sm font-medium h-[46px] md:h-[55px] md:px-36 px-2">
      ...
      <div className="md:py-10 md:px-36 px-0 relative">
        {" "}
        {/* relative追加 */}
